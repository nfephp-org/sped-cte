...
try {
    ...
    $nProt = '143240011994239';
    $nTentativa = '001';
    $tpMotivo = '1';
    $xJustMotivo = null;
    $cHash = 'noTbLtfaoS02PYxVm8ufox7OKww=';
    $nLatitude = '-23.432059';
    $nLongitude = '-46.505813';
    $nSeqEvento = 1;
    $dEntrega = '2024-11-26T15:50:52-03:00';
    $aNFes = ['43241100000210397052559110000012251663226336'];

    $response = $tools->sefazIE(
        $chaveCTe,
        $nProt,
        $nTentativa,
        $tpMotivo,
  ...
  //nesse caso o $json irá conter uma representação em JSON do XML retornado
    ...
    if ($cStat == '101' || $cStat == '135' || $cStat == '155') {
      ...
      //grave o XML protocolado e prossiga com outras tarefas de seu aplicativo
        $filename = "xml/ie/{$chaveCTe}-IE-{$nSeqEvento}-procEvento.xml";
