        ...
        switch ($cst) {
            ...
            case '90':
                if ($outraUF == true) {
                    ...
                    if ($pRedBC > 0) {
                        $this->dom->addChild($icms, 'pRedBCOutraUF', $pRedBC, false, "$identificador Percentual da 
                            Redução de BC Outra UF");
                    }
                    $this->dom->addChild($icms, 'vBCOutraUF', $vBC, true, "$identificador  Valor BC do ICMS Outra UF");
